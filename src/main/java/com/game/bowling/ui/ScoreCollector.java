...
/**
 * This class is responsible to collect all scores from user input
    ...
    private int getNumberOfPinsScored(int remainingPins) {
        ...
        while (pins == null) {
            ...
            if (numberOfPins >= 0 && numberOfPins <= remainingPins) {
                ...
                System.out.println(format("Not a valid number of pins, " + "please enter a number between 1 and %d:", remainingPins));
            }
        }
        return pins;
    }
