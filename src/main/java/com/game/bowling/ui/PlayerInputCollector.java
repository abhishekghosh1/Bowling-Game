...
/**
 * This class is responsible to collect no. of players and their name's input
...
public class PlayerInputCollector {
    ...
    public List<Player> getPlayers() throws Exception {
        System.out.println("With How many players start playing?");
    ...
    private String getValidPlayerName() throws IOException {
        ...
        while (playerName == null) {
            ...
            if (string.matches("^[A-Za-z]+$")) {
                ...
                System.out.println("Invalid player name, only upper and lower case letters are allowed [a-z]. " + "Please try again:");
            }
        }
