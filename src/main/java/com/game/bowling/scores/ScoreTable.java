...
/**
 * This class calculates score after a given frame
...
public class ScoreTable implements ScoreListener {
    ...
    public Player getWinner() {
        Entry<Player, Integer> highestPlayerScoreEntry = Ordering.from(SCORE_COMPARATOR).max(getPlayerScores().entrySet());
