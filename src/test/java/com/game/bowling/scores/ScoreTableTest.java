...
public class ScoreTableTest {
    ...
    public void setUp() {
        ...
        given(mockFrameScoresFactory.newInstance()).willReturn(frame1Scores, frame2Scores, frame3Scores, otherFrameScores);
    ...
    public void canCalculatePerFrameScoreForEachPlayer() throws Exception {
        ...
        // then
        assertThat(scores.getFrameScore(1, maria), is(12));
        assertThat(scores.getFrameScore(2, maria), is(0));
        assertThat(scores.getFrameScore(1, george), is(3));
        assertThat(scores.getFrameScore(2, george), is(9));
    }
    ...
    public void getPlayerScoresAddsUpScoresForEachFrame() {
        ...
        assertThat(scores.getPlayerScores(), is(expectedPlayerScores));
    }
    ...
    public void theWinnerIsThePlayerWithTheMostScore() {
        ...
        // then
        assertThat(scores.getWinner(), is(george));
    }
    ...
    public void getTeamScoreTotalsEachPlayersScore() throws Exception {
        ...
        // then
        assertThat(scores.getTeamScore(), is(11));
    }
