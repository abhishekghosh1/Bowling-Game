...
public class FrameTest {
    ...
    public void notifiesScoreCollectorOfTheRemainingBowlingPins() {
        ...
        given(scoreCollector.takeScore(any(Frame.class), any(Player.class), any(Ball.class))).willReturn(6);
    ...
    public void onlyOneBallIsThrownWhenPlayerGetsAStrikeOnTheFirstBall() {
        ...
        given(scoreCollector.takeScore(any(Frame.class), any(Player.class), any(Ball.class))).willReturn(STRIKE);
    ...
    public void threeBallsArePlayedInTheFinalFrameIfPlayerGetsAStrike() {
        ...
        given(scoreCollector.takeScore(any(Frame.class), any(Player.class), eq(Ball.ONE))).willReturn(STRIKE);
        given(scoreCollector.takeScore(any(Frame.class), any(Player.class), eq(Ball.TWO))).willReturn(3);
        given(scoreCollector.takeScore(any(Frame.class), any(Player.class), eq(Ball.THREE), anyInt())).willReturn(2);
    ...
    public void threeBallsArePlayedInTheFinalFrameIfPlayerGetsASpare() {
        ...
        given(scoreCollector.takeScore(any(Frame.class), any(Player.class), eq(Ball.ONE))).willReturn(7);
        given(scoreCollector.takeScore(any(Frame.class), any(Player.class), eq(Ball.TWO), anyInt())).willReturn(3);
